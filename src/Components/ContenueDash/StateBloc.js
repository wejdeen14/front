...
export default function StateBloc() {
	...
	return (
		<div className="flex gap-4 " style={{marginLeft:"60px"}} >
			<BoxWrapper className="bg-sky-500 rounded-sm p-4 border border-gray-200 flex items-center" style={{ width: '250px', height: '150px'}}>
				...
				<div className="pl-4">
					<span className="text-sm text-zinc-50 font-light"style={{fontSize:'20px'}}> Personnel</span>
					<div className="flex items-center">
						<strong className="text-xl text-zinc-50 font-semibold"style={{fontSize:'30px'}}>{personnelCount}</strong>
